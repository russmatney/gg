...
# gg, a global bb-wrapper

Babashka-tasks are super useful per-project - `gg` exists to dry up some tasks I
started duplicating across godot game dev repos.

> Docs to come soon! For now, check out the [readme](https://github.com/russmatney/gg).
